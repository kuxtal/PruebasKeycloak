...
var app = angular.module('PruebasKeycloak_front', ['ngRoute', 'appControllers']);
...
angular.module('PruebasKeycloak_front').factory('authorization', function ($window) {
	...
	.success((authenticated) => {
		if(authenticated) {
			window._keycloak.loadUserProfile().success(function(profile){
				angular.bootstrap(document, ['PruebasKeycloak_front']); // manually bootstrap Angular
			});
		}
		else {
